    ...
    for (int i = 0; i < NUM_ITERS; ++i) {
        try {
            ...
            std::vector<Fixed>  skill1_samples(NUM_SAMPLES), 
                                ...
                                perf1_1_samples(NUM_SAMPLES),
                                perf2_1_samples(NUM_SAMPLES),
                                perf2_2_samples(NUM_SAMPLES),
                                perf3_2_samples(NUM_SAMPLES),
                                perf1_3_samples(NUM_SAMPLES),
                                perf3_3_samples(NUM_SAMPLES);
            ...
            ppl::Param<Fixed> perf1_1 {perf1_1_samples.data()};
            ppl::Param<Fixed> perf2_1 {perf2_1_samples.data()};
            ppl::Param<Fixed> perf2_2 {perf2_2_samples.data()};
            ppl::Param<Fixed> perf3_2 {perf3_2_samples.data()};
            ppl::Param<Fixed> perf1_3 {perf1_3_samples.data()};
            ppl::Param<Fixed> perf3_3 {perf3_3_samples.data()};
            ...
            auto model = (
                ...
                perf1_1 |= ppl::normal(skill1, Fixed(15.)),
                perf2_1 |= ppl::normal(skill2, Fixed(15.)),
                game1 |= ppl::bernoulli((perf1_1>perf2_1)),

                perf2_2 |= ppl::normal(skill2, Fixed(15.)),
                perf3_2 |= ppl::normal(skill3, Fixed(15.)),
                game2 |= ppl::bernoulli((perf2_2>perf3_2)),

                perf1_3 |= ppl::normal(skill1, Fixed(15.)),
                perf3_3 |= ppl::normal(skill3, Fixed(15.)),
