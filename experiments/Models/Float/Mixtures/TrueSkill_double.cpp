...
int main() {
    ...
    for (int i = 0; i < NUM_ITERS; ++i) {
        try {
            ...
            ppl::Param<cont_t> perf1_1 {perf1_1_samples.data()};
            ppl::Param<cont_t> perf2_1 {perf2_1_samples.data()};
            ppl::Param<cont_t> perf2_2 {perf2_2_samples.data()};
            ppl::Param<cont_t> perf3_2 {perf3_2_samples.data()};
            ppl::Param<cont_t> perf1_3 {perf1_3_samples.data()};
            ppl::Param<cont_t> perf3_3 {perf3_3_samples.data()};
