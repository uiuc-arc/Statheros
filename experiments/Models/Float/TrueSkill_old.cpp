...
int main() {
    ...
    for (int i = 0; i < NUM_ITERS; ++i) {
        try {
            ...
            ppl::Data<int> game1 {1};
            ppl::Data<int> game2 {1};
            ppl::Data<int> game3 {1};
            ...
            ppl::Param<cont_t> perf1 {perf1_samples.data()};
            ppl::Param<cont_t> perf2 {perf2_samples.data()};
            ppl::Param<cont_t> perf3 {perf3_samples.data()};
            ...
            auto model = (
                ...
                perf1 |= ppl::normal(skill1, cont_t(15.)),
                perf2 |= ppl::normal(skill2, cont_t(15.)),
                perf3 |= ppl::normal(skill3, cont_t(15.)),
