...
int main() {
    ...
    for (int i = 0; i < NUM_ITERS; ++i) {
        try {
            ...
            std::vector<cont_param_t> sigma = {15, 10, 16, 11, 9, 11, 10, 18};

            auto model = (
                mu |= ppl::uniform((-20), (20)),
                tau |= ppl::uniform((0), (20)),

                theta_std_1 |= ppl::normal((0), (1)),
                theta_std_2 |= ppl::normal((0), (1)),
                theta_std_3 |= ppl::normal((0), (1)),
                theta_std_4 |= ppl::normal((0), (1)),
                theta_std_5 |= ppl::normal((0), (1)),
                theta_std_6 |= ppl::normal((0), (1)),
                theta_std_7 |= ppl::normal((0), (1)),
                theta_std_8 |= ppl::normal((0), (1)),
