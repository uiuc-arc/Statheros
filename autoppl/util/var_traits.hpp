...
struct VarParent{}; //pointless (non-templated) class we can trivially check inheritance from to see if something is a variable
/**
 ...
 */
template <class T>
struct Var : BaseCRTP<T>, VarParent
