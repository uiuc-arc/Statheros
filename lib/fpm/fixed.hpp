...
template <typename B, typename I, unsigned int F>
inline constexpr bool is_32_base_v = (std::is_same_v<B,std::int32_t> || std::is_same_v<B,int> || std::is_same_v<B,unsigned int> || std::is_same_v<B,std::uint32_t>);


template <typename B, typename I, unsigned int F>
inline constexpr bool is_64_base_v = (std::is_same_v<B,std::int64_t> || std::is_same_v<B,long> || std::is_same_v<B,unsigned long> || std::is_same_v<B,std::uint64_t>);
